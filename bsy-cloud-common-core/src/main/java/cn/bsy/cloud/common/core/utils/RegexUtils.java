 ...
 * @author gaoh
 * @desc 对象属性校验工具
 * @date 2022年01月19日 下午 11:15
 */
public class RegexUtils {
    /**
     * 昵称正则表达式 限10个字符，支持中英文、数字、减号或下划线
     */
    public static final String NICKNAME ="^[\\u4e00-\\u9fa5_a-zA-Z0-9-]{1,10}$";
    /**
     * 6-14 位，字母、数字、特殊字符
     */
    public static final String PASSWORD = "^([A-Z]|[a-z]|[0-9]|[`~!@#$%^&*()+=|{}':;',\\\\[\\\\].<>/?~！@#￥%……&*())_—+|{}【】‘；：”“’。，、？]){6,14}$";
     ...
     * 身份证正则表达式
     */
    public static final String IDCARD = "((1[1-5]|2[1-3]|3[1-7]|4[1-6]|5[0-4]|6[1-5]|8[1-3])\\d{4})" + "((19|20)\\d{2})" + "(0[1-9]|1[0-2])" + "(0[1-9]|[12]\\d|3[01])" + "(\\d{3}([0-9xX]))";

    /**
     * 统一社会信用代码
     */
    public static final String JIGOU_CODE = "^[^_IOZSVa-z\\W]{2}\\d{6}[^_IOZSVa-z\\W]{10}$";
     ...
     * 匹配字符串 年份 yyyy 格式
     */
    public static final String DATE_YYYY="[1-9]{1}[0-9]{3}";

    /**
     * 匹配日期 yyyy-MM-dd HH:mm:ss
     */
    ...
    public static boolean isIdCard(String str) {
        ...
        if (str.trim().length() == length15 || str.trim().length() == length18) {
    ...
    public static boolean isJigouCode(String str) {
        return regular(str, JIGOU_CODE) && str.length()<=22;
    }
     ...
     * @return
     */
    public static boolean isStrNumUnderline(String str) {
    ...
    public static void main(String[] args) {
        String str = "/auth/front/user/xxx";
        String slash  ="/";
        System.out.println(str.indexOf(slash));
